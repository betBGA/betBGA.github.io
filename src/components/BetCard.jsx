...
import { formatUsdc, bgaTableUrl } from "../utils/format.js";
import { BET_STATE_NAMES, ORACLE_FEE } from "../utils/constants.js";
import "./BetCard.css";
          ...
          <span className="bet-card-label">
            ...
            <span className="oracle-fee-badge">
              ...
              <span className="oracle-fee-tooltip">
                A $0.50 oracle fee is deducted to cover game result verification.
              </span>
            </span>
          </span>
